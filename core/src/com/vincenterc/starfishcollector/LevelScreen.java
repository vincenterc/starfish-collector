...
public class LevelScreen extends BaseScreen
{
    ...
    {
        for (BaseActor rockActor : BaseActor.getList(mainStage, "com.vincenterc.starfishcollector.Rock"))
            turtle.preventOverlap(rockActor);

        for (BaseActor starfishActor : BaseActor.getList(mainStage, "com.vincenterc.starfishcollector.Starfish"))
        {
        ...
        for ( BaseActor signActor : BaseActor.getList(mainStage, "com.vincenterc.starfishcollector.Sign") )
        {
